        ...
        <div className={styles.layout}>
          ...
          >
            ...
            <div className={styles.socialBox}>
              <a href="https://github.com/Prem1545" target="_blank" rel="noopener noreferrer" className={styles.socialBtn} aria-label="GitHub">
                <Github size={20} /> Github
              </a>
              <a href="https://www.linkedin.com/in/prem-kumar-mekala-6396332b3?trk=contact-info" target="_blank" rel="noopener noreferrer" className={styles.socialBtn} aria-label="LinkedIn">
